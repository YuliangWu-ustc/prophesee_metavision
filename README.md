...
## Step1: 
Pull the Docker image on the Coder server and create a workspace (if installing directly on a local machine, ensure you are using Ubuntu 22.04)
...
## Step4: 
Create a Conda environment (requires Python 3.10)
```
...
## Step5: 
Make the Conda environment "see" the Metavision module installed on the system
```
